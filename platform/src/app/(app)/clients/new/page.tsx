...
export default function NewClientPage() {
  ...
  return (
    <div className="px-8 pt-10 pb-8 max-w-3xl">
      <div className="mb-8">
        <h1 className="text-base font-semibold" style={{ color: 'var(--text-1)' }}>New Client</h1>
        <p className="text-xs mt-1" style={{ color: 'var(--text-3)' }}>Fill in the intake details to create the client workspace.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="flex gap-3 pt-2">
          ...
          <button
            ...
            className="px-6 py-2.5 text-sm rounded-md transition-colors"
...
function Field({ label, name, type = 'text', required = false, placeholder, textarea = false, className = '' }: {
  ...
  const cls = "mt-1.5 w-full px-3 py-2 rounded-md text-sm transition-colors focus:outline-none"
