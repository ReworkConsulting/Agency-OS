...
│
├── design-system/              ← Platform design constitution. Read before any platform UI work.
│   └── agencyos/
│       └── MASTER.md           ← Generated by ui-ux-pro-max. Colors, typography, animation specs, anti-patterns.
│
...
| Build or redesign a platform UI component | Read `design-system/agencyos/MASTER.md` and follow `workflows/design_platform.md` |
